...
export default function Hero() {
  return (
    <div className="flex flex-col text-center min-h-screen justify-center gap-10 items-center max-w-[800] w-full mx-auto p-4">
      <div className="flex flex-col gap-4">
        <p className="text-base">Its TIME TO GET</p>
